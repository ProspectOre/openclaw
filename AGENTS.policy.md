# OpenClaw Detailed Agent Policy
...
- Review workers should use the root file as a router and read the relevant sections of `AGENTS.policy.md` plus scoped guides. Read the full policy only for a full-repo review; do not rely on truncated snippets when a rule is relevant.
