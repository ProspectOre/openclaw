...
export const FIELD_LABELS: Record<string, string> = {
  ...
  "catalog.feeds.*.url": "Catalog Feed URL",
  "catalog.feeds.*.refresh": "Catalog Feed Refresh",
  "catalog.feeds.*.verification": "Catalog Feed Verification",
  "catalog.sources": "Catalog Sources",
  "catalog.sources.*.type": "Catalog Source Type",
  "catalog.sources.*.registry": "Catalog Source Registry",
  "catalog.sources.*.baseUrl": "Catalog Source Base URL",
  env: "Environment",
